...
class FG_eval {
 public:
  // const double tuneCte = 1000.0;
  // const double tuneEpsi = 1000.0;
  // const double tuneV = 1.0;
  // const double tuneDelta = 50.0;
  // const double tuneA = 50.0;
  // const double tuneDeltaDiff = 250000.0;
  // const double tuneADiff = 5000.0;
